...
import { ComponentProps } from "../../editor/ComponentsContext";
 ...
 */
export declare const FilePanel: <B extends Record<string, import("@blocknote/core").BlockConfig> = import("@blocknote/core").BlockSchemaFromSpecs<{
    paragraph: {
        config: {
            type: "paragraph";
            content: "inline";
...
}>>(props: FilePanelProps<I, S> & Partial<Pick<PanelProps, "defaultOpenTab" | "tabs">>) => import("react/jsx-runtime").JSX.Element;
export {};
