...
export declare const DragHandleButton: <BSchema extends Record<string, import("@blocknote/core").BlockConfig> = import("@blocknote/core").BlockSchemaFromSpecs<{
    paragraph: {
        config: {
            type: "paragraph";
            content: "inline";
...
}>>(props: Omit<SideMenuProps<BSchema, I, S>, "addBlock">) => import("react/jsx-runtime").JSX.Element;
