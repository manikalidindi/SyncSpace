...
export declare const AddBlockButton: <BSchema extends Record<string, import("@blocknote/core").BlockConfig> = import("@blocknote/core").BlockSchemaFromSpecs<{
    paragraph: {
        config: {
            type: "paragraph";
            content: "inline";
...
}>>(props: Pick<SideMenuProps<BSchema, I, S>, "addBlock">) => import("react/jsx-runtime").JSX.Element;
