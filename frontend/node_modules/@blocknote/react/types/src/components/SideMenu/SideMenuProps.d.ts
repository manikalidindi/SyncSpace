...
} & Omit<SideMenuState<BSchema, I, S>, keyof UiElementPosition> & Pick<BlockNoteEditor<BSchema, I, S>["sideMenu"], "addBlock" | "blockDragStart" | "blockDragEnd" | "freezeMenu" | "unfreezeMenu">;
