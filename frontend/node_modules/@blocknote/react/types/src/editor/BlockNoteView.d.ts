...
import React, { ComponentProps, HTMLAttributes, ReactNode, Ref } from "react";
...
export declare const BlockNoteViewRaw: <BSchema extends Record<string, import("@blocknote/core").BlockConfig>, ISchema extends InlineContentSchema, SSchema extends StyleSchema>(props: ComponentProps<typeof BlockNoteViewComponent<BSchema, ISchema, SSchema>> & {
